...
{
	internal class CANChannelsGL3000 : UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(CANChannelsGL3000));
