...
{
	internal class CANChannelsGL1020FTE : UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(CANChannelsGL1020FTE));
			...
			this.tableLayoutPanelChannels.Controls.Add(this.comboBoxBaudrateCAN1, 2, 0);
			this.tableLayoutPanelChannels.Controls.Add(this.comboBoxBaudrateCAN2, 2, 1);
			this.tableLayoutPanelChannels.Controls.Add(this.checkBoxCAN1, 1, 0);
			this.tableLayoutPanelChannels.Controls.Add(this.checkBoxKeepAwakeCAN1, 3, 0);
			this.tableLayoutPanelChannels.Controls.Add(this.checkBoxKeepAwakeCAN2, 3, 1);
			this.tableLayoutPanelChannels.Controls.Add(this.checkBoxLogErrorFramesCAN1, 4, 0);
			this.tableLayoutPanelChannels.Controls.Add(this.checkBoxLogErrorFramesCAN2, 4, 1);
			...
			base.Name = "CANChannelsGL1020FTE";
