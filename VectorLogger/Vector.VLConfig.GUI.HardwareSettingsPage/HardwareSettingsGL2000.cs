...
{
	internal class HardwareSettingsGL2000 : UserControl
	{
		...
		private Label labelStopCyclicComm;
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(HardwareSettingsGL2000));
			...
			this.labelStopCyclicComm = new Label();
			...
			this.groupBoxActivationDelay.Controls.Add(this.labelStopCyclicComm);
			this.errorProviderFormat.SetIconAlignment(this.groupBoxActivationDelay, (ErrorIconAlignment)componentResourceManager.GetObject("groupBoxActivationDelay.IconAlignment"));
			this.errorProviderLocalModel.SetIconAlignment(this.groupBoxActivationDelay, (ErrorIconAlignment)componentResourceManager.GetObject("groupBoxActivationDelay.IconAlignment1"));
			this.errorProviderGlobalModel.SetIconAlignment(this.groupBoxActivationDelay, (ErrorIconAlignment)componentResourceManager.GetObject("groupBoxActivationDelay.IconAlignment2"));
			...
			componentResourceManager.ApplyResources(this.labelStopCyclicComm, "labelStopCyclicComm");
			this.labelStopCyclicComm.Name = "labelStopCyclicComm";
			...
			base.Name = "HardwareSettingsGL2000";
