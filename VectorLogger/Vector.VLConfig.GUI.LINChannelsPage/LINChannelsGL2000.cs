...
{
	internal class LINChannelsGL2000 : UserControl, IValidationHost
	{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(LINChannelsGL2000));
