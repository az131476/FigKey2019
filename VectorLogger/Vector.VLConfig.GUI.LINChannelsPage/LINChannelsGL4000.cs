...
{
	internal class LINChannelsGL4000 : UserControl, IValidationHost
	{
		...
		private CheckBox checkBoxEnableWakeUpLIN1;

		private CheckBox checkBoxEnableWakeUpLIN2;
		...
		private LINprobeChannelRow linprobeChannelRow13;

		private LINprobeChannelRow linprobeChannelRow14;

		private LINprobeChannelRow linprobeChannelRow15;

		private LINprobeChannelRow linprobeChannelRow16;
		...
		private void InitChannelNr2ControlLists()
		{
			...
			this.channelNr2CheckBoxWakeUpEnabled.Add(1u, this.checkBoxEnableWakeUpLIN1);
			this.channelNr2CheckBoxWakeUpEnabled.Add(2u, this.checkBoxEnableWakeUpLIN2);
		...
		private void InitLINprobeChannelTable()
		{
			...
			this.channelNr2LINprobeRow.Add(13u, this.linprobeChannelRow13);
			this.channelNr2LINprobeRow.Add(14u, this.linprobeChannelRow14);
			this.channelNr2LINprobeRow.Add(15u, this.linprobeChannelRow15);
			this.channelNr2LINprobeRow.Add(16u, this.linprobeChannelRow16);
			uint num = 3u;
			while ((ulong)num <= (ulong)((long)(this.channelNr2LINprobeRow.Count + 2)))
			{
		...
		public bool ValidateInput()
		{
			...
			while ((ulong)num <= (ulong)((long)this.channelNr2CheckBoxChannel.Count))
			{
				...
				flag2 |= flag3;
				flag &= this.pageValidator.Control.UpdateModel<bool>(this.channelNr2CheckBoxWakeUpEnabled[num].Checked, this.LINChannelConfiguration.GetLINChannel(num).IsWakeUpEnabled, this.guiElementManager.GetGUIElement(this.channelNr2CheckBoxWakeUpEnabled[num]), out flag3);
				flag2 |= flag3;
		...
		private void UpdateGUI()
		{
			...
			while ((ulong)num <= (ulong)((long)this.linChannelConfiguration.LINChannels.Count))
			{
				...
				this.channelNr2CheckBoxWakeUpEnabled[num].Checked = lINChannel.IsWakeUpEnabled.Value;
				num += 1u;
			}
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(LINChannelsGL4000));
			...
			this.checkBoxEnableWakeUpLIN1 = new CheckBox();
			this.checkBoxEnableWakeUpLIN2 = new CheckBox();
			...
			this.linprobeChannelRow13 = new LINprobeChannelRow();
			this.linprobeChannelRow14 = new LINprobeChannelRow();
			this.linprobeChannelRow15 = new LINprobeChannelRow();
			this.linprobeChannelRow16 = new LINprobeChannelRow();
			...
			this.tableLayoutPanelChannels.Controls.Add(this.checkBoxEnableWakeUpLIN1, 5, 0);
			this.tableLayoutPanelChannels.Controls.Add(this.checkBoxEnableWakeUpLIN2, 5, 1);
			...
			componentResourceManager.ApplyResources(this.checkBoxEnableWakeUpLIN1, "checkBoxEnableWakeUpLIN1");
			this.checkBoxEnableWakeUpLIN1.Name = "checkBoxEnableWakeUpLIN1";
			this.checkBoxEnableWakeUpLIN1.UseVisualStyleBackColor = true;
			this.checkBoxEnableWakeUpLIN1.CheckedChanged += new EventHandler(this.checkBoxWakeUpEnabled_CheckedChanged);
			componentResourceManager.ApplyResources(this.checkBoxEnableWakeUpLIN2, "checkBoxEnableWakeUpLIN2");
			this.checkBoxEnableWakeUpLIN2.Name = "checkBoxEnableWakeUpLIN2";
			this.checkBoxEnableWakeUpLIN2.UseVisualStyleBackColor = true;
			this.checkBoxEnableWakeUpLIN2.CheckedChanged += new EventHandler(this.checkBoxWakeUpEnabled_CheckedChanged);
			...
			this.tableLayoutPanelLINprobe.Controls.Add(this.linprobeChannelRow13, 1, 10);
			this.tableLayoutPanelLINprobe.Controls.Add(this.linprobeChannelRow14, 1, 11);
			this.tableLayoutPanelLINprobe.Controls.Add(this.linprobeChannelRow15, 1, 12);
			this.tableLayoutPanelLINprobe.Controls.Add(this.linprobeChannelRow16, 1, 13);
			...
			this.linprobeChannelRow13.ChannelNr = 0u;
			componentResourceManager.ApplyResources(this.linprobeChannelRow13, "linprobeChannelRow13");
			this.linprobeChannelRow13.LINprobeChannel = null;
			this.linprobeChannelRow13.ModelValidator = null;
			this.linprobeChannelRow13.Name = "linprobeChannelRow13";
			this.linprobeChannelRow14.ChannelNr = 0u;
			componentResourceManager.ApplyResources(this.linprobeChannelRow14, "linprobeChannelRow14");
			this.linprobeChannelRow14.LINprobeChannel = null;
			this.linprobeChannelRow14.ModelValidator = null;
			this.linprobeChannelRow14.Name = "linprobeChannelRow14";
			this.linprobeChannelRow15.ChannelNr = 0u;
			componentResourceManager.ApplyResources(this.linprobeChannelRow15, "linprobeChannelRow15");
			this.linprobeChannelRow15.LINprobeChannel = null;
			this.linprobeChannelRow15.ModelValidator = null;
			this.linprobeChannelRow15.Name = "linprobeChannelRow15";
			this.linprobeChannelRow16.ChannelNr = 0u;
			componentResourceManager.ApplyResources(this.linprobeChannelRow16, "linprobeChannelRow16");
			this.linprobeChannelRow16.LINprobeChannel = null;
			this.linprobeChannelRow16.ModelValidator = null;
			this.linprobeChannelRow16.Name = "linprobeChannelRow16";
