...
{
	internal class LINChannelsGL3000 : UserControl, IValidationHost
	{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(LINChannelsGL3000));
