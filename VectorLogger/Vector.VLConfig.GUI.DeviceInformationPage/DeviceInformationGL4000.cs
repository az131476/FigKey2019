...
{
	internal class DeviceInformationGL4000 : UserControl
	{
		...
		private Label labelFR1and2;

		private Label labelFR1and2Value;
		...
		public DeviceInformationGL4000()
		{
			this.InitializeComponent();
			this.mDevice = null;
			this.richTextBoxDeviceConnectedButCardEmpty.Rtf = Resources.DeviceGL4000ConnectedButCardEmpty;
		...
		public void Init(ILoggerDevice currDevice)
		{
			...
			if (this.mDevice == null || this.mDevice.LoggerType != LoggerType.GL4000)
			{
			...
			if (!this.mDevice.HasLoggerInfo)
			{
				...
				this.labelNoLoggerDeviceConnected.Visible = false;
				this.labelTypeValue.Text = GUIUtil.GetGL4000LoggerSubtypeNameFromSerialNr("", "");
				...
				else if (!this.IsLoggerConnectedDisplayMode && !string.IsNullOrEmpty(this.mDevice.HardwareKey) && this.mDevice.HardwareKey.Length > 3)
				{
				...
				if (this.mDevice is GL4000Device)
				{
					GL4000Device gL4000Device = this.mDevice as GL4000Device;
					...
					this.labelCAN5to8Value.Text = this.GetTransceiverText(gL4000Device.CAN5TransceiverType, 5, gL4000Device);
					this.labelCAN9Value.Text = this.GetTransceiverText(gL4000Device.CAN9TransceiverType, 9, gL4000Device);
				}
			...
			else
			{
				...
				this.richTextBoxDeviceConnectedButCardEmpty.Visible = false;
				this.labelNoLoggerDeviceConnected.Visible = false;
				this.labelTypeValue.Text = GUIUtil.GetGL4000LoggerSubtypeNameFromSerialNr(this.mDevice.SerialNumber, this.mDevice.LogDiskInfo);
				...
				if (this.mDevice is GL4000Device)
				{
					GL4000Device gL4000Device2 = this.mDevice as GL4000Device;
					this.labelCAN1Value.Text = this.GetTransceiverText(gL4000Device2.CAN1TransceiverType, 1, gL4000Device2);
					this.labelCAN2Value.Text = this.GetTransceiverText(gL4000Device2.CAN2TransceiverType, 2, gL4000Device2);
					this.labelCAN3Value.Text = this.GetTransceiverText(gL4000Device2.CAN3TransceiverType, 3, gL4000Device2);
					this.labelCAN4Value.Text = this.GetTransceiverText(gL4000Device2.CAN4TransceiverType, 4, gL4000Device2);
					this.labelCAN5to8Value.Text = this.GetTransceiverText(gL4000Device2.CAN5TransceiverType, 5, gL4000Device2);
					this.labelCAN9Value.Text = this.GetTransceiverText(gL4000Device2.CAN9TransceiverType, 9, gL4000Device2);
					if (gL4000Device2.IsAnalogExtensionBoardInstalled)
					{
					...
					if (gL4000Device2.IsWLANExtensionBoardInstalled)
					{
						this.labelWLANValue.Text = Resources.Yes + " (" + gL4000Device2.InstalledWLANBoardModelName + ")";
					}
					else
					{
		...
		private string GetTransceiverText(CANTransceiverType type, int channelNumber, GL4000Device device)
		{
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(DeviceInformationGL4000));
			...
			this.labelFR1and2Value = new Label();
			...
			this.tableLayoutPanel1.Controls.Add(this.labelDeviceType, 0, 0);
			this.tableLayoutPanel1.Controls.Add(this.labelSerialNumber, 0, 1);
			this.tableLayoutPanel1.Controls.Add(this.labelTypeValue, 1, 0);
			this.tableLayoutPanel1.Controls.Add(this.labelSerialNumberValue, 1, 1);
			...
			this.tableLayoutPanel1.Controls.Add(this.labelFR1and2, 0, 21);
			this.tableLayoutPanel1.Controls.Add(this.labelLIN1and2, 0, 20);
			this.tableLayoutPanel1.Controls.Add(this.labelCAN9, 0, 19);
			this.tableLayoutPanel1.Controls.Add(this.labelCAN5to8, 0, 18);
			this.tableLayoutPanel1.Controls.Add(this.labelCAN4, 0, 17);
			this.tableLayoutPanel1.Controls.Add(this.labelCAN3, 0, 16);
			...
			this.tableLayoutPanel1.Controls.Add(this.labelNaviFiles, 0, 9);
			this.tableLayoutPanel1.Controls.Add(this.labelRecordingFiles, 0, 8);
			this.tableLayoutPanel1.Controls.Add(this.labelTriggeredFiles, 0, 7);
			this.tableLayoutPanel1.Controls.Add(this.labelFreeSpace, 0, 6);
			this.tableLayoutPanel1.Controls.Add(this.labelCapacity, 0, 5);
			this.tableLayoutPanel1.Controls.Add(this.labelInstalledLicenses, 0, 4);
			this.tableLayoutPanel1.Controls.Add(this.labelFirmwareVersion, 0, 3);
			...
			this.tableLayoutPanel1.Controls.Add(this.labelFR1and2Value, 1, 21);
			this.tableLayoutPanel1.Controls.Add(this.labelLIN1and2Value, 1, 20);
			this.tableLayoutPanel1.Controls.Add(this.labelCAN9Value, 1, 19);
			this.tableLayoutPanel1.Controls.Add(this.labelCAN5to8Value, 1, 18);
			this.tableLayoutPanel1.Controls.Add(this.labelCAN4Value, 1, 17);
			this.tableLayoutPanel1.Controls.Add(this.labelCAN3Value, 1, 16);
			...
			this.tableLayoutPanel1.Controls.Add(this.labelNaviFilesValue, 1, 9);
			this.tableLayoutPanel1.Controls.Add(this.labelRecordingFilesValue, 1, 8);
			this.tableLayoutPanel1.Controls.Add(this.labelTriggeredFilesValue, 1, 7);
			this.tableLayoutPanel1.Controls.Add(this.labelFreeSpaceValue, 1, 6);
			this.tableLayoutPanel1.Controls.Add(this.labelCapacityValue, 1, 5);
			this.tableLayoutPanel1.Controls.Add(this.labelInstalledLicensesValue, 1, 4);
			this.tableLayoutPanel1.Controls.Add(this.labelFirmwareVersionValue, 1, 3);
			this.tableLayoutPanel1.Controls.Add(this.labelVehicleName, 0, 2);
			this.tableLayoutPanel1.Controls.Add(this.labelVehicleNameValue, 1, 2);
			this.tableLayoutPanel1.Controls.Add(this.mLinkLabelPackAndGo, 1, 11);
			this.tableLayoutPanel1.Controls.Add(this.labelAnalysisPackage, 0, 12);
			this.tableLayoutPanel1.Controls.Add(this.linkLabelAnalysisPackageValue, 1, 12);
			...
			componentResourceManager.ApplyResources(this.labelFR1and2, "labelFR1and2");
			this.labelFR1and2.Name = "labelFR1and2";
			...
			componentResourceManager.ApplyResources(this.labelFR1and2Value, "labelFR1and2Value");
			this.labelFR1and2Value.Name = "labelFR1and2Value";
			...
			base.Name = "DeviceInformationGL4000";
