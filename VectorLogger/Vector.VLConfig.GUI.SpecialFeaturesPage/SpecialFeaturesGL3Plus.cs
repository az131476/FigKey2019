...
{
	public class SpecialFeaturesGL3Plus : UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(SpecialFeaturesGL3Plus));
			...
			base.Name = "SpecialFeaturesGL3Plus";
