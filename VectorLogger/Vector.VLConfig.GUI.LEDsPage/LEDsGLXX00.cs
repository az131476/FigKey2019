...
{
	internal class LEDsGLXX00 : UserControl, IValidationHost
	{
		...
		private GroupBox groupBoxLEDsOnRemoteControl;
		...
		private void InitLedNrToRowForm()
		{
			...
			this.mLedRow5.Init(5u, 0u, this.mModelValidator);
			this.mLedNrToRowForm.Add(5u, this.mLedRow5);
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(LEDsGLXX00));
			...
			this.mLedRow5 = new LEDRow();
			this.groupBoxLEDsOnRemoteControl = new GroupBox();
			...
			this.groupBoxLEDsOnRemoteControl.SuspendLayout();
			...
			this.tableLayoutPanelChannels.Controls.Add(this.mLedRow5, 0, 4);
			...
			componentResourceManager.ApplyResources(this.mLedRow5, "mLedRow5");
			this.mLedRow5.ConfigItem = null;
			this.mLedRow5.ModelValidator = null;
			this.mLedRow5.Name = "mLedRow5";
			this.groupBoxLEDsOnRemoteControl.Controls.Add(this.tableLayoutPanel1);
			componentResourceManager.ApplyResources(this.groupBoxLEDsOnRemoteControl, "groupBoxLEDsOnRemoteControl");
			this.groupBoxLEDsOnRemoteControl.Name = "groupBoxLEDsOnRemoteControl";
			this.groupBoxLEDsOnRemoteControl.TabStop = false;
			componentResourceManager.ApplyResources(this.tableLayoutPanel1, "tableLayoutPanel1");
			this.tableLayoutPanel1.Controls.Add(this.mLedRow6, 0, 0);
			this.tableLayoutPanel1.Controls.Add(this.mLedRow7, 0, 1);
			this.tableLayoutPanel1.Controls.Add(this.mLedRow8, 0, 2);
			this.tableLayoutPanel1.Controls.Add(this.mLedRow9, 0, 3);
			this.tableLayoutPanel1.Controls.Add(this.mLedRow10, 0, 4);
			this.tableLayoutPanel1.Controls.Add(this.mLedRow11, 0, 5);
			this.tableLayoutPanel1.Controls.Add(this.mLabelAddNamesDesc, 0, 6);
