...
{
	public class GL3000 : ILoggerSpecifics, IMultibusSpecifics, ICANSpecifics, ILINSpecifics, IFlexraySpecifics, IDataStorageSpecifics, IFileConversionSpecifics, IIOSpecifics, IGPSSpecifics, IDeviceAccessSpecifics, IRecordingSpecifics, IDataTransferSpecifics, IConfigurationSpecifics
	{
		...
		IList<string> IDeviceAccessSpecifics.InternalCardReaderModelNames
		{
			get
			{
				if (this.internalDriveModelNames == null)
				{
					...
					this.internalDriveModelNames.Add("GL3000 Data Logger USB Device");
				}
