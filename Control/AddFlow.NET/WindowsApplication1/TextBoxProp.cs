...
{
    [ToolboxItemFilter("System.Windows.Forms"), ProvideProperty("AnsiMaxLength", typeof(TextBox))]
    public sealed class TextBoxProp : Component, IExtenderProvider {
        private class Prop {
            internal Prop() {
            }
...
//            this.AdjustBaseFromAuto();
        ...
        public TextBoxProp(IContainer cont) : this() {
            cont.Add(this);
        }
...
//        }
        ...
        [Localizable(true), DefaultValue(0), Description("")]
        public int GetAnsiMaxLength(Control control) {
            Prop prop = (Prop) this.tools[control];
            if (prop == null) return 0;
            return prop.MaxLength;
        }

        public void SetAnsiMaxLength(Control control, int maxLength) {
