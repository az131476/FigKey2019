...
namespace ServiceModelEx
{
   ...
   {      
      Dictionary<string,TransportClientEndpointBehavior> m_NamespaceCredentials = new Dictionary<string,TransportClientEndpointBehavior>();
      ...
      void OnConfigureDiscovery(object sender,EventArgs e)
      {
         ...
         if(String.IsNullOrWhiteSpace(dialog.AnnouncementsPath) == false)
         {
            ...
            m_ServiceBusAnnouncementSinks[serviceNamespace] = new ServiceBusAnnouncementSink<IMetadataExchange>(serviceNamespace,issuer,secret);
