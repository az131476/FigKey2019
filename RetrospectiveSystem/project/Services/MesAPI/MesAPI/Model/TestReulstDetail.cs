...
namespace MesAPI.Model
{
    public class TestResultItemContent
    {
        ...
        public const string Main_Soft_Version_Item = "主软件版本";
        public const string Work_Electric_Test = "工作电流测试";
        ...
        public const string BootloaderVersion = "网络报文读取Bootloader版本号";
        public const string RadioFreq = "射频测试";
        public const string DormantElect = "休眠电流";
        public const string FrontCover = "前盖";
        public const string BackCover = "后盖";
        ...
        public const string StentScrew1 = "支架螺丝1";
        public const string StentScrew2 = "支架螺丝2";
        public const string Stent = "支架";
        public const string LeftStent = "左支架";
        public const string RightStent = "右支架";
